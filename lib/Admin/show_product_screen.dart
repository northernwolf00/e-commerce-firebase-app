      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => CreateMarkedsProductsScreen(shopId: shopId),
            ),
          );
        },
      ),
