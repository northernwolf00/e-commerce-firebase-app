...
class CreateMarkedsScreen extends StatefulWidget {

  final Map<String, dynamic>? existingData;

  CreateMarkedsScreen({ this.existingData});
  @override
  _CreateMarkedsScreenState createState() => _CreateMarkedsScreenState();
}

class _CreateMarkedsScreenState extends State<CreateMarkedsScreen> {
  ...
  Future<void> _saveMarked() async {
    ...
    try {
        await FirebaseFirestore.instance.collection('markedLists').add(shopsData);
        ScaffoldMessenger.of(context)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Add Marked')),
